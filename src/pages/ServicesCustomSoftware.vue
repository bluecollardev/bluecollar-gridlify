  ...
  <Layout>
        ...
        <div class="sm-flex flex-column bg-firebrand-red pad-top pad-bottom">
          ...
          <div class="sm-flex">
            <div class="sm-flex">
              ...
              <div class="flex-basis-half space-all">
                <div class="space-bottom-half">
                  <p class="g-pstyle6">Immersive &lsquo;Canvas&rsquo; Ads</p>
                </div>
                <div>
    ...
    <section id="advertising" class="lg-flex">
      <div class="sm-flex flex-center flex-justify-center flex-basis-third">
        <div class="content-block">
          <div class="space-bottom-half">
            <p class="g-pstyle9">Targeted Ads</p>
          </div>
          <div>
      ...
      <div class="sm-flex flex-basis-two-thirds flex-wrap">
        ...
        <div class="flex-basis-half">
          <div class="space-all">
            <div class="space-bottom-half">
              <p class="g-pstyle9">Professional ad targeting</p>
            </div>
            <div>
              <p>Don&rsquo;t waste time and money on audiences who aren&rsquo;t in the market for what you&rsquo;re selling.  We understand how to segment the market to only target social media users who are right for your business.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="real-estate" class="lg-flex">
      <div class="sm-flex flex-column flex-center flex-justify-center flex-basis-third">
        <div class="content-block">
          <div class="space-bottom-half">
        ...
        <div class="bg-salmon space-all no-space-bottom relative">
          ...
          <div class="figure-caption-full bg-cherry pad-all">
            ...
            <div class="g-help-with-digital-marketing">
              ...
              <p class="g-pstyle7">RE/MAX Elite</p>
            </div>
          </div>
        </div>
      </div>
      <div class="sm-flex flex-column flex-center flex-justify-center flex-basis-third">
        <div class="space-all">
          <div class="space-bottom-half">
            <p class="g-pstyle9">Easily Post New Listings</p>
          </div>
          <div>
            <p>We build accelerated landing pages that pull data directly from your MLS board - enabling you to easily share and promote your listings on social media platforms.  If the status of the listing changes, the listing automatically updates on your posts - saving you time and the hassle of updating the posts manually.</p>
          </div>
        </div>
        <div class="space-all">
          <div class="space-bottom-half">
            <p class="g-pstyle9">Instant Conversations with Leads</p>
          </div>
          <div>
