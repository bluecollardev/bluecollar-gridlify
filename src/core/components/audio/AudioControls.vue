<template>
  <div class="controls">
    <button @click="(audio) => onShuffleClicked()" class="backward" title="Backward"><i class="fa fa-retweet fa-lg"></i>
    </button>
    <button @click="(audio) => onPreviousClicked()" class="backward" title="Backward"><i
        class="fa fa-backward fa-2x"></i></button>
    <button @click="(audio) => onPlayPauseClicked()" class="play-pause" title="Play" onclick=""><i
        class="fa fa-play fa-3x"></i></button>
    <button @click="(audio) => onNextClicked()" class="forward" title="Forward"><i class="fa fa-forward fa-2x"></i>
    </button>
    <button @click="(audio) => onRandomClicked()" class="backward" title="Backward"><i class="fa fa-random fa-lg"></i>
    </button>
