<template>
  <div>
    <div style="position: relative; top: -15vh">
      ...
      <section id="services" class="col-3-squares no-pad-bottom lg-flex"
               style="position: absolute; width: 100%; z-index: 10; transform: translateY(-3vh)">
        <div class="service-detail-card-top fixed-height-mobile flex flex-center flex-justify-center flex-basis-third">
          <video class="video-block-bg drop-shadow rotate-right is-hidden--sm-down" preload="none" playsinline=""
                 autoplay="" muted="" loop=""
                 poster="">
        ...
        <div
            class="service-detail-card-top flex flex-center flex-justify-center flex-basis-third xs-hide sm-hide md-hide">
          <div class="service-detail-card-inner space-left space-right sm-space-top-2x sm-space-bottom-2x">
        ...
        <div class="service-detail-card-top fixed-height-mobile flex flex-center flex-justify-center flex-basis-third">
          <video class="video-block-bg drop-shadow rotate-left is-hidden--sm-down" preload="none" playsinline=""
                 autoplay="" muted="" loop=""
                 poster="">
      ...
      <section class="hero-section shift-section-up angle bg-bc-blue no-pad-bottom lg-flex">
        <div class="col-3-squares bg-bc-blue no-pad-bottom lg-flex">
          ...
          <div
              class="service-detail-card-top fixed-height-mobile flex flex-center flex-justify-center flex-basis-third">
            <video class="video-block-bg scale-center drop-shadow-up is-hidden--sm-down" preload="none" playsinline=""
                   autoplay="" muted="" loop=""
                   poster="">
